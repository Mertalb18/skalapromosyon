"""
Django settings for skalapromosyon project.
...
SECRET_KEY = 'django-insecure-v#!b#_$rd(1slcxfh7n7kg=#l^(z_-)3zdwj!+xi9_7t1^8000'
...
ROOT_URLCONF = 'skalapromosyon.urls'
...
WSGI_APPLICATION = 'skalapromosyon.wsgi.application'
